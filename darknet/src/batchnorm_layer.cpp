...
layer make_batchnorm_layer(int batch, int w, int h, int c)
{
  ...
  cudnnSetTensor4dDescriptor(
      l.normTensorDesc, CUDNN_TENSOR_NCHW, CUDNN_DATA_FLOAT, 1, l.out_c, 1, 1);
...
void forward_batchnorm_layer(layer l, network net)
{
  ...
  if (net.train)
  {
    ...
    variance_cpu(
        l.output, l.mean, l.batch, l.out_c, l.out_h * l.out_w, l.variance);
    ...
    normalize_cpu(
        l.output, l.mean, l.variance, l.batch, l.out_c, l.out_h * l.out_w);
    copy_cpu(l.outputs * l.batch, l.output, 1, l.x_norm, 1);
  }
  else
  {
    normalize_cpu(l.output,
                  l.rolling_mean,
                  l.rolling_variance,
                  l.batch,
                  l.out_c,
...
void backward_batchnorm_layer(layer l, network net)
{
  ...
  backward_scale_cpu(
      l.x_norm, l.delta, l.batch, l.out_c, l.out_w * l.out_h, l.scale_updates);
...
void forward_batchnorm_layer_gpu(layer l, network net)
{
  ...
  if (net.train)
  {
    ...
    fast_variance_gpu(l.output_gpu,
                      l.mean_gpu,
                      l.batch,
                      l.out_c,
                      l.out_h * l.out_w,
...
void backward_batchnorm_layer_gpu(layer l, network net)
{
...
#else
  backward_bias_gpu(
      l.bias_updates_gpu, l.delta_gpu, l.batch, l.out_c, l.out_w * l.out_h);
  backward_scale_gpu(l.x_norm_gpu,
                     l.delta_gpu,
                     l.batch,
                     l.out_c,
                     l.out_w * l.out_h,
  ...
  fast_mean_delta_gpu(l.delta_gpu,
                      l.variance_gpu,
                      l.batch,
                      l.out_c,
                      l.out_w * l.out_h,
