                            ...
                            float decay)
{
  ...
  axpy_cpu(
      l.inputs * l.outputs, -decay * batch, l.weights, 1, l.weight_updates, 1);
  axpy_cpu(l.inputs * l.outputs,
           learning_rate / batch,
           l.weight_updates,
           1,
           l.weights,
...
void forward_connected_layer(connected_layer l, network_state state)
{
  ...
  if (l.batch_normalize)
  {
    ...
    {
      normalize_cpu(
          l.output, l.rolling_mean, l.rolling_variance, l.batch, l.outputs, 1);
    }
...
void backward_connected_layer(connected_layer l, network_state state)
{
  ...
  {
    backward_scale_cpu(
        l.x_norm, l.delta, l.batch, l.outputs, 1, l.scale_updates);
...
void update_connected_layer_gpu(connected_layer l,
                                int batch,
                                float learning_rate,
                                float momentum,
                                float decay)
