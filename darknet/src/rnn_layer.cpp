...
void backward_rnn_layer(layer l, network net)
{
  ...
  for (i = l.steps - 1; i >= 0; --i)
  {
    ...
    if (i > 0 && l.shortcut)
      axpy_cpu(l.outputs * l.batch,
               1,
               self_layer.delta,
               1,
               self_layer.delta - l.outputs * l.batch,
               1);
...
void backward_rnn_layer_gpu(layer l, network net)
{
  ...
  for (i = l.steps - 1; i >= 0; --i)
  {
    ...
    {
      fill_gpu(l.outputs * l.batch, 0, l.state_gpu, 1);
      axpy_gpu(l.outputs * l.batch,
               1,
               input_layer.output_gpu - l.outputs * l.batch,
               1,
               l.state_gpu,
               1);
      axpy_gpu(l.outputs * l.batch,
               1,
               self_layer.output_gpu - l.outputs * l.batch,
               1,
               l.state_gpu,
               1);
    }
    ...
    copy_gpu(
        l.outputs * l.batch, self_layer.delta_gpu, 1, input_layer.delta_gpu, 1);
