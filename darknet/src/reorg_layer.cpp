...
void forward_reorg_layer(const layer l, network net)
{
  ...
  else if (l.extra)
  {
    ...
    {
      copy_cpu(
          l.inputs, net.input + i * l.inputs, 1, l.output + i * l.outputs, 1);
    }
  }
  else if (l.reverse)
  {
...
void backward_reorg_layer(const layer l, network net)
{
  ...
  else if (l.extra)
  {
    ...
    {
      copy_cpu(
          l.inputs, l.delta + i * l.outputs, 1, net.delta + i * l.inputs, 1);
    }
  }
  else
  {
