...
void backward_gru_layer_gpu(layer l, network net)
{
  ...
  for (i = l.steps - 1; i >= 0; --i)
  {
    ...
    mult_add_into_gpu(
        l.outputs * l.batch, l.forgot_delta_gpu, l.state_gpu, ur.delta_gpu);
