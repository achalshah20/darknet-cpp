                                                 ...
                                                 ACTIVATION activation)
{
  ...
  fprintf(stderr,
          "Deconvolutional Layer: %d x %d x %d image, %d filters -> %d x %d x "
          "%d image\n",
          h,
          w,
          c,
...
void resize_deconvolutional_layer(deconvolutional_layer *l, int h, int w)
{
  ...
  l->col_image_gpu =
      cuda_make_array(l->col_image, out_h * out_w * l->size * l->size * l->c);
...
void update_deconvolutional_layer(deconvolutional_layer l,
                                  int a,
                                  float learning_rate,
                                  float momentum,
                                  float decay)
