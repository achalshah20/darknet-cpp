...
void forward_upsample_layer(const layer l, network net)
{
  ...
  {
    upsample_cpu(
        net.input, l.w, l.h, l.c, l.batch, l.stride, 1, l.scale, l.output);
  }
}
...
void backward_upsample_layer(const layer l, network net)
{
  ...
  {
    upsample_cpu(
        net.delta, l.w, l.h, l.c, l.batch, l.stride, 0, l.scale, l.delta);
  }
}
